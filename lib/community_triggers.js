...
function buildFirstCommunityEmail(firstName, community) {
  ...
  var canisterUrl = baseUrl + '/canister.html';
...
'      </p>' +
'      <div style="margin-top:12px;padding-top:12px;border-top:1px solid #f0efe9;font-size:12px;color:#b8b4ae;line-height:1.6">' +
'        <strong style="color:#1a1714">EventMedium is in live beta.</strong> We\'re actively fixing bugs and improving the experience. If anything doesn\'t work as expected or you have a suggestion, we want to hear it \u2014 <a href="https://www.eventmedium.ai/feedback.html" style="color:#1a1714">share your feedback here</a>.' +
'      </div>' +
